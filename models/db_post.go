...
// Prepare does pre-processing for data
func (p *Post) Prepare() {
	p.ID = 0
...
// SavePost saves post to database
...
// FindAllPosts returns all posts
...
// FindPostByID returns post by ID
...
// UpdateAPost updates post by ID
...
// DeleteAPost deletes post by ID
